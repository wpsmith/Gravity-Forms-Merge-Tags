 ...
 */
class GW_Post_Content_Merge_Tags extends WPS_GF_Merge_Tags {
	...
	public function init( $args ) {
		...
		// Just in case: Gravity Forms 1.9 has note to replace gform_replace_merge_tags with gform_merge_tag_filter in GFCommon, line 933.
		add_filter( 'gform_merge_tag_filter', array( $this, 'replace_encrypt_entry_id_merge_tag' ), 10, 3 );
